...
type BlogPostDocumentDataSlicesSlice = BlockquoteSlice | RichTextSlice;
...
type PageDocumentDataSlicesSlice = FullVideoSlice | HeroSlice | RichTextSlice;
...
/**
 * Primary content in *FullVideo → Primary*
 */
export interface FullVideoSliceDefaultPrimary {
  /**
   * Background Video field in *FullVideo → Primary*
   *
   * - **Field Type**: Embed
   * - **Placeholder**: *None*
   * - **API ID Path**: full_video.primary.background_video
...
/**
 * Default variation for FullVideo Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type FullVideoSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<FullVideoSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *FullVideo*
 */
type FullVideoSliceVariation = FullVideoSliceDefault;

/**
 * FullVideo Shared Slice
 *
 * - **API ID**: `full_video`
 * - **Description**: FullVideo
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type FullVideoSlice = prismic.SharedSlice<
  "full_video",
  FullVideoSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      FullVideoSlice,
      FullVideoSliceDefaultPrimary,
      FullVideoSliceVariation,
      FullVideoSliceDefault,
      HeroSlice,
